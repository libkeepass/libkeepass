...
from libkeepass.common import read_signature
from libkeepass.kdb3 import KDB3Reader, KDB3_SIGNATURE
from libkeepass.kdb4 import KDB4Reader, KDB4_SIGNATURE
